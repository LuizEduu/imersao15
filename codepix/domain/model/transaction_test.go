...
func TestNewTransaction(t *testing.T) {
	...
	_, err = model.NewTransaction(account, amount, pixKeySameAccount, "My description", "any_id")
...
func TestModel_ChangeStatusOfATransaction(t *testing.T) {
	...
	amount := 3.10
	transaction, _ := model.NewTransaction(account, amount, pixKey, "My description", "any_id")
